...
namespace DungeonCarver.Godot
{
    ...
    public class Leaf
    {
        ...
        private Rect2I _room;
        private Rect2I _room1;
        private Rect2I _room2;
        ...
        private Rect2I GetRoom()
        {
            ...
            else if (_room2 == new Rect2I())
            {
                return _room1;
            }
            else if (_room1 == new Rect2I())
            {
                return _room2;
            }
